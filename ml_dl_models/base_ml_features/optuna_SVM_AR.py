...
MODEL_SAVE_PATH    = 'SVM_on_AR_optuna.pkl'
OPTUNA_STORAGE     = "sqlite:///study_SVM_AR.db"
LOG_TO_FILE        = 'test_results_SVM_AR_optuna.md'
OPTUNA_N_TRIALS    = 50

AR_ORDER = 6  # Order of AR model (number of lags)
