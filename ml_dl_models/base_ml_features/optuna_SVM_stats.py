...
MODEL_SAVE_PATH = 'SVM_on_stats_optuna.pkl'  # Updated model save path
OPTUNA_STORAGE = "sqlite:///study_SVM_stats.db"  # Updated Optuna study storage
log_to_file = 'test_results_SVM_stats_optuna.md'  # Updated log file
OPTUNA_N_TRIALS = 50
...
def objective(trial: Trial):
    ...
    pipe_steps = [
        ('fe', FeatureExtractor(
            sfreq=250,
            selected_funcs=['mean', 'variance', 'skewness', 'kurtosis']
        )),
