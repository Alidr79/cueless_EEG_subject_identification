...
MODEL_SAVE_PATH    = 'XGB_on_psd_optuna.pkl'
OPTUNA_STORAGE     = "sqlite:///study_XGB_psd.db"
LOG_TO_FILE        = 'test_results_XGB_psd_optuna.md'
OPTUNA_N_TRIALS    = 50

SFREQ = 250
PSD_N_FREQS = 30  # Number of frequency bins to retain
