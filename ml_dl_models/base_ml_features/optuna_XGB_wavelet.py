...
MODEL_SAVE_PATH = 'XGB_on_wavelet_optuna.pkl'
OPTUNA_STORAGE = "sqlite:///study_XGB_wavelet.db"  # Optuna study storage
log_to_file = 'test_results_XGB_wavelet_optuna.md'
OPTUNA_N_TRIALS = 50
