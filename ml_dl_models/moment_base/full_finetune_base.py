...
def save_model(model, optimizer, scheduler, epoch, save_path="checkpoints_base_val-4_test-5", extra_file_str = ""):
...
log_to_file = 'finetune_100_epochs_base_val-4_test-5_log.md'
epoch = 100
