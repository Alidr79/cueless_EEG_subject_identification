...
# EMBEDDINGS_PATH = 'zero-shot_base_embeddings.npy'

METADATA_PATH = '../all_metadata.csv'
MODEL_SAVE_PATH = 'XGBoost_on_MOMENT_base_finetuned_optuna.pkl'  # Updated model save path
OPTUNA_STORAGE = "sqlite:///study_XGBoost_moment_base_finetuned.db"  # Updated Optuna study storage
LOG_FILE = 'test_results_XGBoost_on_MOMENT_base_finetuned_optuna.md'  # Updated log file
OPTUNA_N_TRIALS = 50
