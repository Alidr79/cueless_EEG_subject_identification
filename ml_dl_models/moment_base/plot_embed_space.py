...
embeddings = np.load('32-shot_base_embeddings.npy')
...
plt.xlabel("tSNE_1")
plt.ylabel("tSNE_2")
plt.title("tSNE plot of 32-shot MOMENT-base test embeddings")
plt.savefig('32-shot_base_embedding(colors_subjects).png')