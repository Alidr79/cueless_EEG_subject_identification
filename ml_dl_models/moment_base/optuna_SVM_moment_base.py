...
MODEL_SAVE_PATH = 'SVM_on_MOMENT_base_zero-shot_optuna.pkl'  # Updated model save path
OPTUNA_STORAGE = "sqlite:///study_SVM_moment_base_zero-shot.db"  # Updated Optuna study storage
LOG_FILE = 'test_results_SVM_on_MOMENT_base_zero-shot_optuna.md'  # Updated log file
OPTUNA_N_TRIALS = 50
