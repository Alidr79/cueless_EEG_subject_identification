...
embeddings = np.load('51-shot_small_embeddings.npy')
...
plt.xlabel("tSNE_1")
plt.ylabel("tSNE_2")
plt.title("tSNE plot of 51-shot MOMENT-small test embeddings")
plt.savefig('51-shot_small_embedding(colors_subjects).png')