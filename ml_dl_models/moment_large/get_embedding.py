...
device = 'cuda'
checkpoint = torch.load('checkpoints_val-4_test-5/model_epoch_best_35.pth')
model.load_state_dict(checkpoint['model_state_dict'])
all_embeddings, all_labels = get_embeddings(model, device, all_loader)

np.save('35-shot_large_embeddings.npy', all_embeddings)
np.save('35-shot_large_labels.npy', all_labels)