...
MODEL_SAVE_PATH = 'XGBoost_on_MOMENT_large_zero-shot_optuna.pkl'  # Updated model save path
OPTUNA_STORAGE = "sqlite:///study_XGBoost_moment_large_zero-shot.db"  # Updated Optuna study storage
LOG_FILE = 'test_results_XGBoost_on_MOMENT_large_zero-shot_optuna.md'  # Updated log file
OPTUNA_N_TRIALS = 50
