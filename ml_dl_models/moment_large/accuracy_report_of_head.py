...
predictions = np.load('35-shot_large_labels.npy')
...
with open("MOMENT_large_full_finetuned_head_accuracy_report.md", "a") as log_file:  # Open in append mode
    log_file.write("35-shot_large_labels.npy")
