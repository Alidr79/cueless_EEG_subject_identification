...
def run_scalability_experiment():
    ...
    for n_subjects in range(2, 11):  # 2 to 10 subjects
        ...
        # Setup Optuna study
        study_name = f"study_ShallowFBCSPNet_{n_subjects}subjects"
...
def generate_markdown_report(results):
    ...
    with open(report_path, 'w') as f:
        ...
        f.write("## Overview\n\n")
        f.write("This report analyzes how the ShallowFBCSPNet model performance scales ")
        f.write("with an increasing number of subjects (classes) from 2 to 11.\n\n")
        
        f.write("## Configuration\n\n")
        f.write(f"- **Model:** ShallowFBCSPNet\n")
