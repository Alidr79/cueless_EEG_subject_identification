...
CHECKPOINT_SAVE_PATH = "checkpoints_ShallowFBCSPNet_train-1,2,3_val-4_test-5"
OPTUNA_STUDY_NAME = "study_ShallowFBCSPNet_train-1,2,3_val-4_test-5"
OPTUNA_SAVE_LOG = "sqlite:///study_ShallowFBCSPNet_train-1,2,3_val-4_test-5.sqlite3"
OPTUNA_N_TRIALS = 50
...
optimizer = torch.optim.AdamW(final_model.parameters(), lr=0.0026522515163981968, weight_decay=0.00041580870922518004)
n_epochs = 25  # you may use more epochs if you want
